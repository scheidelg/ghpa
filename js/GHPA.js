...
async function ghpaLoadPage() {
     ...
     * sessionStorage.  This is either a base64-encoded GitHub authentication
     * token; or that string after being AES-256 encrypted. */
        ...
        await fetch(request).then(async function (response) {
            ...
            if (ghpaSSOFlag && (response.status == 200 || response.status == 404)) {
                ...
                * the GitHub credentails. */
                ...
                /* Save the credentials to sessionStorage.  They should be
