...
There are multiple options, from a security perspective, for using GitHub Pages Authorization (GHPA). There are some mitigating factors for even the worst option but here's the bottom line.
